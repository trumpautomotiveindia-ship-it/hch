...
$h_line1 = get_theme_mod( 'hch_hero_line1', defined('HCH_HERO_LINE1') ? HCH_HERO_LINE1 : __( 'Every EV part.', 'hch-electric' ) );
$h_line2 = get_theme_mod( 'hch_hero_line2', defined('HCH_HERO_LINE2') ? HCH_HERO_LINE2 : __( 'Every spec.', 'hch-electric' ) );
$h_line3 = get_theme_mod( 'hch_hero_line3', defined('HCH_HERO_LINE3') ? HCH_HERO_LINE3 : __( 'One source.', 'hch-electric' ) );
$hsub   = get_theme_mod( 'hch_hero_sub', defined('HCH_HERO_SUB') ? HCH_HERO_SUB : __( 'Electric Scooters', 'hch-electric' ) );
